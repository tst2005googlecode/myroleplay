...
function mrpiOnLoad()
	...
	if (mrpCheckSettings("MyRolePlay Interface", "Fade Time") == nil) then
		mrpAddSetting("MyRolePlay Interface", "Fade Time", 2);
	end

	if (mrpCheckSettings("MyRolePlay Interface", "Hide List") == nil) then
		mrpAddSetting("MyRolePlay Interface", "Hide List", {});
	end

	if (mrpCheckSettings("MyRolePlay Interface", "Fade List") == nil) then
		mrpAddSetting("MyRolePlay Interface", "Fade List", {});
	end

	if (mrpCheckSettings("MyRolePlay Interface", "Switch List") == nil) then
		mrpAddSetting("MyRolePlay Interface", "Switch List", {});
	end
	
	if (mrpCheckSettings("MyRolePlay Interface", "Fade Disp Delay") == nil) then
